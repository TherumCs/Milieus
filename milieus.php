...
require_once MILIEUS_DIR . 'includes/welcome.php';
require_once MILIEUS_DIR . 'includes/onboarding.php';
require_once MILIEUS_DIR . 'includes/block.php';
